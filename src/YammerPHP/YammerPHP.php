...
class YammerPHP
{
     ...
     * @return string
     */
    public function getAuthorizationUrl($callbackUrl = null)
    {
        ...
        /* Authorization URL */
        $url = sprintf(
            'https://www.yammer.com/dialog/oauth?client_id=%s&redirect_uri=%s',
            $this->consumerKey,
    ...
    private function request($url, $data = array(), $isPost = false)
    {
        ...
        if (isset($return->BODY->H2) && isset($return->BODY->H1) && $return->BODY->H2 == 'Error 401') {
